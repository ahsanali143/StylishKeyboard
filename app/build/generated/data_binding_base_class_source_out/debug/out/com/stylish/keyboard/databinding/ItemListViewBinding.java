...
public final class ItemListViewBinding implements ViewBinding {
  ...
  private ItemListViewBinding(@NonNull LinearLayout rootView, @NonNull TextView wordTextView) {
  ...
  public static ItemListViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListViewBinding((LinearLayout) rootView, wordTextView);
    }
